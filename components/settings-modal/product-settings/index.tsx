...
export default function ProductSettings() {
  ...
  return (
    <div className=''>
      <div className='flex w-full flex-col gap-3.5 px-5 py-4 sm:flex-row sm:items-center'>
        <div className='flex-1'>
          ...
          <DialogPrimitives.Description className='mt-1 text-paragraph-sm text-text-sub-600'>
            Manage your product display and inventory settings
      ...
      <TabMenuHorizontal.Root defaultValue='default'>
        <TabMenuHorizontal.List className='px-5'>
          <TabMenuHorizontal.Trigger value='default'>
            Default
          </TabMenuHorizontal.Trigger>
          <TabMenuHorizontal.Trigger value='categories'>
            Categories
          </TabMenuHorizontal.Trigger>
          <TabMenuHorizontal.Trigger value='inventory'>
            Inventory
          </TabMenuHorizontal.Trigger>
